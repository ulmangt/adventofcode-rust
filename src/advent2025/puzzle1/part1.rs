...
fn read_input_data( ) -> Result<Vec<String>,InputDataError> {
    let asset_path = format!("{}/assets/2025/puzzle1/part1/input.txt", env!("CARGO_MANIFEST_DIR"));
...
fn parse_input_data( input_lines: Vec<String> ) -> Result<Vec<(u32,u32)>,InputDataError> {
